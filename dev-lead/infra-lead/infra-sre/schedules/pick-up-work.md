...
3. PICK UP WORK (if no active assignment):
   ...
   gitea_api GET 'repos/molecule-ai/molecule-ci/issues?state=open&type=issues&limit=50' | python3 -m json.tool
   ...
   gitea_api GET 'repos/molecule-ai/molecule-ci/pulls?state=open&limit=50' | python3 -m json.tool
