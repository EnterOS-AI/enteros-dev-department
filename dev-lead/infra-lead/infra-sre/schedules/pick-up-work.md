...
3. PICK UP WORK (if no active assignment):
   ...
   gitea_api 'repos/molecule-ai/molecule-ci/issues?state=open&type=issues&limit=50' | python3 -m json.tool
   gitea_api 'repos/molecule-ai/molecule-ai-workspace-runtime/issues?state=open&type=issues&limit=50' | python3 -m json.tool
