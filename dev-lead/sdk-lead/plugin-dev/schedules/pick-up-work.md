...
3. PICK UP WORK (if no active assignment):
   ...
   gitea_api 'repos/issues/search?owner=molecule-ai&type=issues&state=open&q=molecule-ai-plugin&limit=50' | python3 -m json.tool
   gitea_api 'repos/molecule-ai/molecule-core/issues?state=open&type=issues&limit=50' | python3 -m json.tool
   gitea_api 'repos/issues/search?owner=molecule-ai&type=pulls&state=open&q=molecule-ai-plugin&limit=50' | python3 -m json.tool
